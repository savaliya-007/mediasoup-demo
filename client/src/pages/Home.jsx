...
export default function Home({ setView, setUser, setRoom }) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center text-white">
      <div className="bg-gray-900/80 backdrop-blur-md border border-gray-700 rounded-2xl shadow-2xl p-8 w-[87.5] space-y-6">
        ...
        {!mode && (
          <div className="space-y-3">
            <button
              className="w-full bg-linear-to-r from-blue-600 to-indigo-600 py-2 rounded-lg font-semibold"
            ...
            <button
              className="w-full bg-linear-to-r from-purple-600 to-pink-600 py-2 rounded-lg font-semibold"
